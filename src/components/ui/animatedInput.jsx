  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none outline dark:text-white bg-transparent text-black h-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-4",
          animating && "text-transparent dark:text-transparent"
        )}
      />

      <div className="absolute inset-0 flex items-center pointer-events-none outline">
